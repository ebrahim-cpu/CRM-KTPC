<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List_Investors_Activities2.aspx.cs" Inherits="CRM.List_Investors_Activities2" %>
...
<body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="List_Investors_Activities2.aspx">2. Activity List</a></li>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-sm-11">
                            3.<a href="List_Investors_Activities2.aspx" class="btn btn-primary">List Of Investor's Activities</a>
                            This will display list of Investor's Activities. You will need to select Investors Name in the drop down list at the top left hand side. 
                        </div>
                        <div class="col-sm-11">
    ...
    <hr />
    <div class="container">
        <p>&copy; <%: DateTime.Now.ToString("dd/MMM/yyyy") %> - KTPC Sdn. Bhd. CRM v1.0 | Last Update: 31 March 2023</p>
    </div>
</body>
</html>
