...
namespace CRM
{
    public partial class FileManage_Investors_Profile : System.Web.UI.Page
    {
        ...
        protected void BtnSimpan_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Data has been saved.'); window.location='" + ResolveUrl("FileManage_Investors_Profile.aspx?id=") + Id + "';", true);
            }
            catch (Exception ex)
            {
