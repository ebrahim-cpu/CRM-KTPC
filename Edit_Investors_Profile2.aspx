<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit_Investors_Profile2.aspx.cs"
    Inherits="CRM.Edit_Investors_Profile2" %>
    ...
    <body>
        <div class="container">
                ...
                <%--START NAV--%>
                            ...
                            <li><a href="Dashboard.aspx">Dashboard</a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="List_Investors_Activities.aspx">2. Investor's Activity List</a>
                                        </li>
                                        <li><a href="List_Contacts.aspx">3. Contact List</a></li>
                    ...
                    <%--END NAV--%>
                        <div class="col-sm-12">
                            <center>
                                <h2>
                                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-success btn-lg">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                5.
                                <asp:Label for="txtCompanyAddress" runat="server" Text="Address"></asp:Label>
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlCountry" CssClass="form-control" runat="server"
                                    AutoPostBack="false" onchange="updateTextboxCountry()"></asp:DropDownList><br />
                            </div>
                            <div class="form-group">
                                7.
                                <asp:Label for="txtCompanyPhone" runat="server" Text="Phone"></asp:Label>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtWebsite" runat="server" CssClass="form-control"
                                    placeholder="https://www." MaxLength="200"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                9.
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtBranches" runat="server" CssClass="form-control"
                                    placeholder="Branches" TextMode="MultiLine" Rows="3"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                12.
                                <asp:Label for="txtCompanyContactPerson" runat="server" Text="Contact Person">
                                </asp:Label>
                                <asp:TextBox ID="txtCompanyContactPerson" runat="server" CssClass="form-control"
                                    placeholder="Contact Person" MaxLength="100"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                13.
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlPIC" CssClass="form-control" runat="server"
                                    AutoPostBack="false" onchange="updateTextboxPromotedSector()"></asp:DropDownList>
                                <br />
                            </div>
                            <div class="form-group">
                                15.
                                <asp:Label for="ddlInvestmentType" runat="server" Text="Investment Type"></asp:Label>
                                <asp:DropDownList ID="ddlInvestmentType" CssClass="form-control" runat="server"
                                    AutoPostBack="false" onchange="updateTextboxInvestmentType()"></asp:DropDownList>
                                <br />
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <b>C. Land and Building Requirement</b>
                            <hr class="rounded" />
                            <div class="form-group">
                                16.
                            ...
                            <div class="form-group">
                                17.
                                <asp:Label for="txtPSFRM" runat="server" Text="PSF/(RM)"></asp:Label>
                            ...
                            <div class="form-group">
                                18.
                                <asp:Label for="txtBuildingSize" runat="server" Text="Building Size (sf)"></asp:Label>
                        ...
                        <div class="col-sm-6">
                            <b>E. Total Investment, Man Power, Timeline</b>
                            <hr class="rounded" />
                            <div class="form-group">
                                23.
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    26.
                                    <asp:Label for="txtStartConstructionDate" runat="server"
                                        Text="Start Construction Date"></asp:Label>
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtStartOperationDate" runat="server" CssClass="form-control"
                                        placeholder="dd/mm/yyyy" TextMode="Date"></asp:TextBox>
                                </div>
                                28.
                                ...
                                <asp:TextBox ID="txtCompanyDescription" runat="server" CssClass="form-control"
                                    placeholder="Company Description" TextMode="MultiLine" Rows="3"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <b>F. Investor's Status</b>
                            <hr class="rounded" />
                            <div class="form-group">
                                29.
                                ...
                                <asp:DropDownList ID="ddlInvestorStatus" CssClass="form-control" runat="server"
                                    AutoPostBack="false" onchange="updateTextboxInvestorStatus()">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    31.
                                    <asp:Label for="ddlPersonInCharge" runat="server" Text="Person In Charge">
                                    </asp:Label>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <asp:Button ID="btnSubmit" CssClass="btn btn-success" runat="server" Text="Save"
                                    OnClientClick="return validateCompanyName();" OnClick="BtnSubmit_Click" />
                                <asp:Button ID="btnCancel" CssClass="btn btn-danger" runat="server" Text="Cancel"
                                    OnClick="BtnCancel_Click" />
                                <br />
                                Please Click Save, to Update Investors Information.
                            </div>
                        </div>
                        <!-- Modal RFP -->
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlDecisionStatus" CssClass="form-control"
                                                runat="server" onchange="updateTextboxDecisionStatus()">
                                            ...
                                            <%-- <asp:TextBox ID="txtDecisionStatus" CssClass="form-control"
                                                runat="server" MaxLength="100"></asp:TextBox>--%>
                                        </div>
                                        <div class="form-group">
                                            <label for="txtDecisionDescription">Decision Comments:</label>
                                            <asp:TextBox ID="txtDecisionDescription" CssClass="form-control"
                                                runat="server" TextMode="MultiLine" Rows="3" MaxLength="200">
                                            </asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                        ...
                        <div>
                            <div class="col-sm-12">
                                <hr class="rounded" />
                                <p>Please make sure Documents or Photos are less 50MB in size. Thank You.</p>
                                <div class="form-group row">
                                    <asp:Label for="DocumentUpload1" runat="server" Text="32. Attach Documents">
                                    </asp:Label>
                                    <asp:FileUpload runat="server" ID="DocumentUpload1" AllowMultiple="true" />
                                    <asp:Button runat="server" ID="btnUploadDocument" Text="Upload"
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                            AllowSorting="True" DataKeyNames="Document_Id" OnSorting="GridView1_Sorting"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="Document_Id" HeaderText="ID"
                                                    SortExpression="Document_Id" />
                                                <asp:TemplateField HeaderText="File Name">
                                                    <ItemTemplate>
                                                        <a
                                                            href='<%# Eval("Document_Id", "DownloadFiles_Profiles.aspx?Document_Id={0}") %>'>
                                                            <%# Eval("FileName") %>
                                                        </a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
            ...
            <%-- <script src="lightbox/lightbox-plus-jquery.js"></script>--%>
                ...
                <hr />
                <div class="col-sm-12">
                    <p>&copy; <%: DateTime.Now.ToString("dd/MMM/yyyy") %> - KTPC Sdn. Bhd. CRM v1.0 | Last Update: 6
                            April 2023</p>
                </div>
        </div>
    </body>
