...
namespace CRM
{
    public partial class ConfirmDelete_ProfilePhoto : System.Web.UI.Page
    {
        ...
        private bool DeletePhotoFromDatabase(int photoId)
        {
            try
            {
                ...
                {
                    connection.Open();
                    using (SqlCommand command = new SqlCommand("DELETE FROM Photo_IProfile WHERE Document_Id = @Photo_Id", connection))
                    {
