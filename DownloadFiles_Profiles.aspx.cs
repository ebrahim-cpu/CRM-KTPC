...
namespace CRM
{
    public partial class DownloadFiles_Profiles : System.Web.UI.Page
    {
        ...
        private void DownloadFromDatabase(int fileId)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                SqlCommand cmd = new SqlCommand(
                    "SELECT FileName, FileData, ContentType FROM Document_IProfile WHERE Document_Id = @FileId", connection);
