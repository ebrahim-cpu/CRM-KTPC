<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List_Investors_Activities_2.aspx.cs"
    Inherits="CRM.List_Investors_Activities_2" %>
    ...
    <body>
                ...
                <%--END NAV--%>
                    ...
                    <div class="col-sm-12">
                        ...
                        <asp:DropDownList ID="ddlCompanyName" runat="server"
                            OnSelectedIndexChanged="ddlCompanyName_SelectedIndexChanged" AutoPostBack="True">
                        </asp:DropDownList>
                        &nbsp;&nbsp;&nbsp;&nbsp;Select Status:
                        <asp:DropDownList ID="ddlInvestorStatus" runat="server" AutoPostBack="True"
                            OnSelectedIndexChanged="ddlInvestorStatus_SelectedIndexChanged">
                    ...
                    <div class="col-sm-6" align="right">
                        <a href="New_Investors_Activities.aspx" class="btn btn-default" data-toggle="tooltip"
                            data-placement="bottom" title="New Investor Activity"><span
                                class="glyphicon glyphicon-plus"></span></a>
                        <a href="Dashboard.aspx" class="btn btn-default" data-toggle="tooltip" data-placement="bottom"
                        ...
                        <%--<a href="New_Investors_Profile.aspx" class="btn btn-primary">Add New Investors</a>
                            ...
                            <span data-toggle="modal" data-target="#helpDialog">
                                <a class="btn btn-default" data-toggle="tooltip" data-placement="bottom"
                                    title="Apps Assistance"><span class="glyphicon glyphicon-cog"></span></a>
                            </span>
                    </div>
                    <div class="col-sm-12">
                        <asp:GridView ID="gvActivities" runat="server" CssClass="table table-hover table-condensed"
                            AutoGenerateColumns="False" OnRowDeleting="gvActivities_RowDeleting" DataKeyNames="Id"
                            CellPadding="4" ForeColor="#000000" GridLines="None" AllowSorting="True"
                            OnSorting="gvActivities_Sorting" OnRowEditing="gvActivities_RowEditing">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Activity_Date_Start" HeaderText="Date"
                                    DataFormatString="{0: dd/MMM/yy}" SortExpression="Activity_Date_Start" />

                                <asp:BoundField DataField="Company_Status" HeaderText="Status"
                                    SortExpression="Company_Status" />
                                <asp:BoundField DataField="Activity_Description" HeaderText="Description" />
                                <asp:BoundField DataField="UpdatedDate" HeaderText="Updated"
                                    DataFormatString="{0: dd/MMM/yy}" SortExpression="UpdatedDate" />
                                ...
                                <asp:TemplateField ItemStyle-Width="100">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server" data-toggle="tooltip" title="Edit"
                                            CssClass="btn btn-primary btn-xs" CommandName="Edit"><span
                                                class="glyphicon glyphicon-pencil"></span></asp:LinkButton>
                                        <asp:LinkButton ID="lnkDelete" runat="server" data-toggle="tooltip"
                                            title="Delete" CssClass="btn btn-danger btn-xs" CommandName="Delete"
                                            OnClientClick="return confirm('Are you sure you want to delete this record?');">
                                            <span class="glyphicon glyphicon-trash"></span></asp:LinkButton>
                                        <asp:LinkButton ID="btnFiles" runat="server" data-toggle="tooltip" title="Files"
        ...
        <hr />
        <div class="col-sm-11">
            Please select the Investor's Name to get the list of activities for each Investors. Click button Files
            (green) to upload and attach files for each activities.
            Click button Edit (blue) to edit Investor's activities record. Click button Delete (red) to delete
            Investor's activities record.
        </div>
        <br />

        <hr />
        <div class="container">
            <p>&copy; <%: DateTime.Now.ToString("dd/MMM/yyyy") %> - KTPC Sdn. Bhd. CRM v1.0 | Last Update: 15 March 2023
            </p>
        </div>
    </body>
