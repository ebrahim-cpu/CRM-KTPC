...
namespace CRM
{
    public partial class Edit_Investors_Activities : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(query, con))
                {
                    ...
                    cmd.Parameters.AddWithValue("@Activity_Date_Start", DateTime.Parse(txtActivityDateStart.Text));
                    cmd.Parameters.AddWithValue("@Activity_Date_End", DateTime.Parse(txtActivityDateStart.Text)); // Buang nanti kalau tak perlu.
