<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit_Investors_Activities.aspx.cs" Inherits="CRM.Edit_Investors_Activities" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="txtCompanyName" runat="server" CssClass="form-control" Enabled="false" />
            </div>
            <%--            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <asp:DropDownList ID="ddlInvestorStatus" CssClass="form-control" runat="server" AutoPostBack="False" onchange="updateTextboxInvestorStatus()">
            ...
            <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-success" OnClick="btnSave_Click" OnClientClick="return confirm('Are you sure you want to save this activity?');" />
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:Button ID="btnSaveRfpDetails" runat="server" Text="Save" CssClass="btn btn-primary" />
                    </div>
                </div>
