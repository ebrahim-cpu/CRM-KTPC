<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_Investors_Profile.aspx.cs"
    Inherits="CRM.List_Investors_Profile_V2" %>
                ...
                <%--END NAV--%>
                    <div class="col-sm-12">
                        ...
                        <asp:GridView ID="gvActivities" runat="server" CssClass="table table-hover table-condensed"
                            ...
                            AllowSorting="True" OnSorting="GvActivities_Sorting" OnRowEditing="GvActivities_RowEditing"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Date_Inquiry" HeaderText="Date Inquiry"
                                    SortExpression="Date_Inquiry" DataFormatString="{0:dd-MMM-yyyy}" HtmlEncode="False" />
                                ...
                                <asp:BoundField DataField="Land_Size_Required" HeaderText="Land (acre)"
                                    SortExpression="Land_Size_Required" />
                                <asp:BoundField DataField="Building_Size" HeaderText="Building (sf)"
                                    SortExpression="Building_Size" />
                                <asp:BoundField DataField="Company_Industry_Type" HeaderText="Promoted Sector"
                                    SortExpression="Company_Industry_Type" />
                                <asp:TemplateField HeaderText="Invest Type" SortExpression="Investment_Type"
                                    ItemStyle-Width="120px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnInvestmentType" runat="server"
                                            Text='<%# Eval("Investment_Type") %>'
                                            CssClass='<%# GetLeadsStatusStyle(Eval("Investment_Type").ToString()) %>'
                                            CommandName="Sort" CommandArgument="Investment_Type" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="Company_Country" HeaderText="Country"
                                    SortExpression="Company_Country" />
                                <asp:TemplateField HeaderText="Status" SortExpression="Leads_Status"
                                    ItemStyle-Width="120px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnLeadsStatus" runat="server"
                                            Text='<%# Eval("Leads_Status") %>'
                                            CssClass='<%# GetLeadsStatusStyle(Eval("Leads_Status").ToString()) %>'
                                            CommandName="Sort" CommandArgument="Leads_Status" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="Investors_Decision_Making" HeaderText="Decision Making"
                                    SortExpression="Investors_Decision_Making" />
                                <asp:BoundField DataField="Investors_Internal_Status" HeaderText="Internal Status"
                                    SortExpression="Investors_Internal_Status" />
