...
namespace CRM
{
    public partial class List_Investors_Activities_3 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                Session[name: "FromLocation"] = "List_Investors_Activities";
                ...
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["CRMConnectionString"].ConnectionString))
                {
                    ...
                    SqlCommand arahan = new SqlCommand("SELECT DISTINCT Company_Name FROM Investors_Profile", con);
